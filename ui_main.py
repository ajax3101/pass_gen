...
"}")
        ...
        self.btn_visible = QPushButton(self.frame_password)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/invisibility.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u":/icons/icons/visibility.svg", QSize(), QIcon.Normal, QIcon.On)
        self.btn_visible.setIcon(icon2)
        self.btn_visible.setIconSize(QSize(30, 30))
...
"}")
        ...
        self.layout_info.addWidget(self.label_strenght)
        ...
        self.slider_legth = QSlider(self.centralwidget)
        self.slider_legth.setObjectName(u"slider_legth")
        self.slider_legth.setCursor(QCursor(Qt.PointingHandCursor))
        self.slider_legth.setStyleSheet(u"QSlider::groove:horizontal {\n"
"    background-color: transparent;\n"
"    height: 5px;\n"
"}\n"
"\n"
...
"    margin-bottom: -8px;\n"
"}")
        self.slider_legth.setMaximum(100)
        self.slider_legth.setValue(12)
        self.slider_legth.setOrientation(Qt.Horizontal)

        self.layout_length.addWidget(self.slider_legth)
